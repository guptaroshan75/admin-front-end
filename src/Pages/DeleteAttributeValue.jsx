...
const DeleteAttributeValue = ({ fetchAllAttributeValues, attribute }) => {
    const handleDeleteAttributeVal = async (_id) => {
        try {
            await axios.delete(`${API}/deleteAttributeValues/${_id}`);
            ...
            >
                ...
                >
                    ...
                    <Button sx={{
                        ...
                        onClick={() => handleDeleteAttributeVal(attribute?._id)}
                    >
                        Yes, Delete It
                    </Button>
                </Box>
