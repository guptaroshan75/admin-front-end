...
const Gallery = () => {
    ...
    return (
        <Box sx={{ flexGrow: 1, px: 3, mt: 10, ml: 30, mb: 20 }} >
            <Navbar />
            <Typography variant="h5" sx={{ my: 2, fontWeight: 800 }}> Gallery </Typography>
            <Paper sx={{
            ...
            >
                ...
                <Box my={2}>
                    ...
                    <Button>
                        <GalleryAdd handleChangeInput={handleChangeInput} addGallery={addGallery}
                            setAddGallery={setAddGallery} handleFileUpload={handleFileUpload}
                            fetchAllGallery={fetchAllGallery}
                        />
                    </Button>
                </Box>
            </Paper>
            ...
            <Box my={2}>
                <GalleryList gallery={gallery} key={gallery?._id} />
            </Box>
        </Box>
    )
}
