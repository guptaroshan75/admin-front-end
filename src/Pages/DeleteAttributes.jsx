...
const DeleteAttributes = ({ fetchAllAttribute, attribute }) => {
    const handleDeleteCategory = async (_id) => {
        try {
            await axios.delete(`${API}/deleteAttribute/${_id}`);
            toast.error("Attributes Deleted Successfully");
            fetchAllAttribute();
        ...
        <>
            ...
            >
                <DeleteOutlineIcon sx={{
                    fontSize: 25, ml: 1, color: "#9e9e9e", "&:hover":
                        { color: "#f58484" },
                }}
                />
            </Typography>
            ...
            >
                ...
                >
                    ...
                    <Button onClick={() => handleDeleteCategory(attribute?._id)} sx={{
