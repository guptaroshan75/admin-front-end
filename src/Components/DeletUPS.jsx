...
const DeleteUPS = ({ fetchAllUpsShipping, upsShipping }) => {
    ...
    const handleDeleteUPS = async (_id) => {
        try {
            await axios.delete(`${API}/deleteUpsShipping/${_id}`);
            toast.error("UPS Deleted Successfully");
            ...
            >
                ...
                >
                    ...
                    <Button sx={{
                        ...
                        onClick={() => handleDeleteUPS(upsShipping?._id)}
                    >
                        Yes, Delete It
                    </Button>
                </Box>
