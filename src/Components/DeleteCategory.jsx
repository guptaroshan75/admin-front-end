...
const DeleteCategory = ({ fetchAllCategory, category }) => {
  ...
  return (
    <>
      ...
      >
        ...
        <Divider />
        <Box display={"flex"} justifyContent={"center"} sx={{ bgcolor: "rgba(0, 0, 0, 0.04)" }} >
          ...
          <Button sx={{ ml: 2, my: 3, bgcolor: "#3b9c55", "&:hover": { bgcolor: "#357546" } }}
            onClick={() => handleDeleteCategory(category?._id)} variant="contained"
          >
            Yes, Delete It
          </Button>
        </Box>
